...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'provensuccess-crm:install
    ...
    /**
     * Install and configure ProvenSuccess.
     */
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for ProvenSuccess kickstart...');
    ...
    protected function askForApplicationDetails()
    {
        $this->updateEnvVariable(
            ...
            env('APP_NAME', 'ProvenSuccess CRM')
        );
    ...
    protected function createAdminCredentials()
    {
        ...
        try {
            ...
            File::put($filePath, 'ProvenSuccess is successfully installed');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use ProvenSuccess.');
