        ...
        <div class="flex gap-6 max-lg:flex-wrap">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                    <div class="flex gap-6 max-md:flex-col">
                        ...
                        <div class="flex-shrink-0">
                            @if($extension->logo)
                                ...
                                <div
                                    class="hidden h-32 w-32 items-center justify-center rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30">
                                    <span class="icon-package text-5xl text-blue-600 dark:text-blue-400"></span>
                                </div>
                            @else
                                <div
                                    class="flex h-32 w-32 items-center justify-center rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30">
                                    <span class="icon-package text-5xl text-blue-600 dark:text-blue-400"></span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between gap-4 max-md:flex-col">
                                <div>
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        @if($extension->is_featured)
                                            <span
                                                class="flex items-center gap-1 rounded-full bg-gradient-to-r from-yellow-400 to-orange-400 px-3 py-1 text-sm font-medium text-white">
                                ...
                                <div class="flex flex-col items-end gap-3 max-md:items-start max-md:w-full">
                                    ...
                                    @if($isInstalled)
                                        <button type="button" class="secondary-button w-full min-w-[200px]" disabled>
                                    ...
                                    @else
                                        @auth
                                            @if($extension->price > 0)
                                                <form action="{{ route('marketplace.install.extension', $extension->id) }}"
                                        ...
                                        @else
                                            <a href="{{ route('admin.session.create') }}"
                                                class="primary-button w-full min-w-[200px] text-center">
                    ...
                    <!-- Stats Bar -->
                    <div
                        class="mt-6 grid grid-cols-2 gap-4 border-t border-gray-200 pt-6 dark:border-gray-700 md:grid-cols-4">
                        <!-- Downloads -->
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                {{ number_format($extension->reviews_count) }}
                                @lang('marketplace::app.marketplace.detail.reviews')
                            </p>
                        </div>
                    ...
                    <div class="mt-6 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div x-data="screenshotCarousel()" class="relative">
                            ...
                            <div class="overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800">
                                <img :src="currentScreenshot" :alt="'Screenshot ' + (currentIndex + 1)"
                                ...
                                <div class="mt-4 flex gap-2 overflow-x-auto pb-2">
                                    @foreach($extension->screenshots as $index => $screenshot)
                                        <button @click="currentIndex = {{ $index }}"
                                            ...
                                            <img src="{{ Storage::url($screenshot) }}" alt="Screenshot {{ $index + 1 }}"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="font-semibold text-gray-900 dark:text-white">
                                                ...
                                                @if($loop->first)
                                                    <span
                                                        class="ml-2 rounded-full bg-green-100 px-2 py-1 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-200">
                ...
                <div class="mt-6 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        @auth
                            ...
                            @elseif(!$hasReviewed)
                                <button type="button" class="secondary-button" @click="$refs.reviewModal.open()">
                        ...
                        <div class="flex items-center gap-6">
                            <div class="text-center">
                                ...
                                <div class="mt-2 flex justify-center gap-1">
                                    @for($i = 1; $i <= 5; $i++)
                                        <span
                                            class="icon-star {{ $i <= round($extension->average_rating) ? 'text-yellow-500' : 'text-gray-300 dark:text-gray-600' }}"></span>
                                    @endfor
                                </div>
                        ...
                        <div class="space-y-2">
                            @for($rating = 5; $rating >= 1; $rating--)
                                ...
                                <div class="flex items-center gap-3">
                                    <span class="text-sm font-medium text-gray-600 dark:text-gray-400 w-8">{{ $rating }}
                                        <span class="icon-star text-xs text-yellow-500"></span></span>
                                    ...
                                    <span
                                        class="text-sm text-gray-600 dark:text-gray-400 w-12 text-right">{{ $count }}</span>
                                </div>
                            @endfor
                        </div>
                    </div>
                ...
                <div class="mt-4 rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="space-y-2">
                        @if($extension->documentation_url)
                            <a href="{{ $extension->documentation_url }}" target="_blank"
                                class="flex items-center gap-2 text-sm text-blue-600 hover:underline dark:text-blue-400">
                        ...
                        @if($extension->demo_url)
                            <a href="{{ $extension->demo_url }}" target="_blank"
                                class="flex items-center gap-2 text-sm text-blue-600 hover:underline dark:text-blue-400">
                        ...
                        @if($extension->repository_url)
                            <a href="{{ $extension->repository_url }}" target="_blank"
                                class="flex items-center gap-2 text-sm text-blue-600 hover:underline dark:text-blue-400">
                        ...
                        @if($extension->support_email)
                            <a href="mailto:{{ $extension->support_email }}"
                                class="flex items-center gap-2 text-sm text-blue-600 hover:underline dark:text-blue-400">
                    ...
                    <div class="mt-4 rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div class="space-y-3">
                            @foreach($relatedExtensions->take(3) as $related)
                                <a href="{{ route('marketplace.extension.show', $related->slug) }}"
                                    class="flex gap-3 rounded-lg border border-gray-200 p-3 transition-all hover:shadow-md dark:border-gray-700">
                                    @if($related->logo)
                                        <img src="{{ Storage::url($related->logo) }}" alt="{{ $related->name }}"
                                            class="h-12 w-12 flex-shrink-0 rounded object-cover"
                                            onerror="this.onerror=null; this.style.display='none'; this.nextElementSibling.style.display='flex';" />
                                        <div
                                            class="hidden h-12 w-12 flex-shrink-0 items-center justify-center rounded bg-gray-100 dark:bg-gray-800">
                                            <span class="icon-package text-lg text-gray-500"></span>
                                        </div>
                                    @else
                                        <div
                                            class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded bg-gray-100 dark:bg-gray-800">
                                            <span class="icon-package text-lg text-gray-500"></span>
                                        </div>
                                    @endif
