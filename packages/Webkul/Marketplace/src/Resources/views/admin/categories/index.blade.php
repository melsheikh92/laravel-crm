<x-admin::layouts>
    ...
    <div class="flex flex-col gap-4">
            ...
            <div class="flex items-center gap-x-2.5">
                <div class="flex items-center gap-x-2.5">
                    ...
                    @if (bouncer()->hasPermission('marketplace.categories.create'))
                        <a
                            href="{{ route('admin.marketplace.categories.create') }}"
        ...
        <div v-show="viewMode === 'tree'" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
            ...
            app.component('v-category-tree', {
                ...
                methods: {
                    async loadTreeData() {
                        ...
                        try {
                            const response = await this.$axios.get('{{ route('admin.marketplace.categories.tree') }}');
