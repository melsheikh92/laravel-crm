    ...
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                <a
                    href="{{ route('admin.marketplace.revenue.transactions') }}"
        ...
        @if(isset($statistics))
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <!-- Total Platform Fees -->
                <div class="box-shadow flex flex-col gap-2 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                ...
                <!-- Net Revenue -->
                <div class="box-shadow flex flex-col gap-2 rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-800 dark:bg-purple-900/20">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div class="box-shadow flex flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="flex h-64 items-center justify-center text-gray-500 dark:text-gray-400">
                    <v-charts-bar
                        :labels='@json(['Gross Revenue', 'Platform Fees', 'Seller Revenue', 'Refunds'])'
                        :datasets='@json([[
                            'label' => 'Amount ($)',
                            'data' => [
