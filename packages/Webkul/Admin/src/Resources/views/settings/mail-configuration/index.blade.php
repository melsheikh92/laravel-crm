<x-admin::layouts>
    ...
    <x-slot:title>
        ...
        <x-admin::form :action="route('admin.settings.mail_configuration.store')" method="POST">
            <div class="flex flex-col gap-4">
                ...
                <v-mail-configuration :smtp-config="{{ json_encode($smtpConfig) }}"
                    :imap-config="{{ json_encode($imapConfig) }}"></v-mail-configuration>
            </div>
        </x-admin::form>
        ...
        @pushOnce('scripts')
            <script type="text/x-template" id="v-mail-configuration-template">
                <div class="flex flex-col gap-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.smtp.host')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.smtp.host')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.smtp.host')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.smtp.port')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.smtp.port')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.smtp.port')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.smtp.encryption')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.smtp.encryption')"
                                >
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.smtp.username')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.smtp.username')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.smtp.username')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.smtp.password')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.smtp.password')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.smtp.password')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.smtp.from-address')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.smtp.from-address')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.smtp.from-address')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.smtp.from-name')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.smtp.from-name')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.smtp.from-name')"
                                />
                    ...
                    <div v-show="activeTab === 'imap'" class="box-shadow rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.imap.host')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.imap.host')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.imap.host')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.imap.port')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.imap.port')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.imap.port')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.imap.encryption')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.imap.encryption')"
                                >
                                    <option value="tls">@lang('admin::app.settings.mail-configuration.index.tls')</option>
                                    <option value="ssl">@lang('admin::app.settings.mail-configuration.index.ssl')</option>
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.imap.username')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.imap.username')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.imap.username')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.mail-configuration.index.imap.password')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.settings.mail-configuration.index.imap.password')"
                                    :placeholder="trans('admin::app.settings.mail-configuration.index.imap.password')"
                                />
                    ...
                    <div v-show="activeTab === 'templates'" class="box-shadow rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <a
                                ...
                                class="secondary-button"
                            >
                                @lang('admin::app.settings.mail-configuration.index.templates.manage-templates')
                            </a>
                        </div>
