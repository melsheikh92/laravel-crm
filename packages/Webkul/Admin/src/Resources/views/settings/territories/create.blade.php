<x-admin::layouts>
    ...
    <x-slot:title>
        ...
        <x-admin::form :action="route('admin.settings.territories.store')" method="POST">
                ...
                <div class="flex gap-2.5 max-xl:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                        <div
                            ...
                            <v-territory-boundaries :data='@json(old('boundaries'))'></v-territory-boundaries>
                                ...
                                <x-slot:content>
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control type="select" id="type" name="type"
                                            ...
                                            <option value="">@lang('admin::app.settings.territories.create.select-type')
                                            </option>
                                            <option value="geographic">
                                                @lang('admin::app.settings.territories.create.geographic')</option>
                                            <option value="account-based">
                                                @lang('admin::app.settings.territories.create.account-based')</option>
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control type="select" id="parent_id"
                                            name="parent_id" value="{{ old('parent_id') }}"
                                            :label="trans('admin::app.settings.territories.create.parent-territory')">
                                            <option value="">@lang('admin::app.settings.territories.create.none')
                                            </option>
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control type="select" id="user_id" name="user_id"
                                            rules="required" value="{{ old('user_id') }}"
                                            :label="trans('admin::app.settings.territories.create.owner')">
                                            <option value="">
                                                @lang('admin::app.settings.territories.create.select-owner')</option>
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control type="select" id="status" name="status"
                                            rules="required" value="{{ old('status', 'active') }}"
                                            :label="trans('admin::app.settings.territories.create.status')">
                                            <option value="active">
                                                @lang('admin::app.settings.territories.create.active')</option>
                                            <option value="inactive">
                                                @lang('admin::app.settings.territories.create.inactive')</option>
                                        </x-admin::form.control-group.control>
