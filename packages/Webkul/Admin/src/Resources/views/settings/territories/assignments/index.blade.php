                ...
                <div class="flex items-center gap-x-2.5">
                    <div class="flex items-center gap-x-2.5">
                        ...
                        @if (bouncer()->hasPermission('settings.territories.assignments.edit'))
                            ...
                            <button type="button" class="secondary-button" @click="$refs.bulkReassignModal.open()">
                        ...
                        @if (bouncer()->hasPermission('settings.territories.assignments.create'))
                            ...
                            <a href="{{ route('admin.settings.territories.assignments.create') }}" class="primary-button">
                    ...
                    <x-slot:header>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="select" id="bulk_territory_id"
                                    name="territory_id" rules="required"
                                    :label="trans('admin::app.settings.territory-assignments.index.territory')"
                                    v-model="bulkReassignData.territory_id">
                                    <option value="">
                                        @lang('admin::app.settings.territory-assignments.index.select-territory')
                                    </option>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="switch" id="bulk_transfer_ownership"
                                    name="transfer_ownership" value="1"
                                    :label="trans('admin::app.settings.territory-assignments.index.transfer-ownership')"
                                    v-model="bulkReassignData.transfer_ownership" :checked="true" />
                ...
                app.component('x-admin-layouts', {
                    ...
                    methods: {
                        bulkReassign(params) {
                            ...
                            // Send request
                            this.$axios
                                .post('{{ route('admin.settings.territories.assignments.bulk_reassign') }}', this.bulkReassignData)
                                .then(response => {
                                    this.$emitter.emit('add-flash', {
                                        type: 'success',
