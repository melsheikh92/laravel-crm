<x-admin::layouts>
    <x-slot:title>
        ...
        <div class="mb-5 flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                @if (bouncer()->hasPermission('settings.territories.view'))
                    <a href="{{ route('admin.settings.territories.index') }}" class="secondary-button">
        ...
        @pushOnce('scripts')
            ...
            <script type="text/x-template" id="v-territory-analytics-template">
                <!-- Shimmer -->
                ...
                <div class="mt-3.5 flex gap-4 max-xl:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col gap-4 max-xl:flex-auto">
                        ...
                        <div
                            ...
                            <canvas :id="$.uid + '_territory_chart'" class="w-full"></canvas>
                        </div>
                        ...
                        <div
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    ...
                                    <tbody>
                                        <tr v-for="territory in territories" :key="territory.territory_id"
                    ...
                    <div class="flex w-[378px] max-w-full flex-col gap-4 max-sm:w-full">
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <div v-for="(territory, index) in topRevenue" :key="'revenue-' + territory.territory_id"
                                    class="mb-3 last:mb-0">
                                    <div class="mb-1 flex items-center justify-between">
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-xs font-semibold text-purple-600 dark:bg-purple-900 dark:text-purple-300">
                                                @{{ index + 1 }}
                                            </span>
                                            <span class="text-sm font-medium dark:text-gray-300">@{{ territory.name
                                                }}</span>
                                        </div>
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <div v-for="(territory, index) in topConversion"
                                    :key="'conversion-' + territory.territory_id" class="mb-3 last:mb-0">
                                    <div class="mb-1 flex items-center justify-between">
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-xs font-semibold text-blue-600 dark:bg-blue-900 dark:text-blue-300">
                                                @{{ index + 1 }}
                                            </span>
                                            <span class="text-sm font-medium dark:text-gray-300">@{{ territory.name
                                                }}</span>
                                ...
                                <div v-if="topConversion.length === 0"
                                    class="py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                    @lang('admin::app.settings.territories.analytics.no-data')
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <div v-for="(territory, index) in topLeads" :key="'leads-' + territory.territory_id"
                                    class="mb-3 last:mb-0">
                                    <div class="mb-1 flex items-center justify-between">
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="flex h-6 w-6 items-center justify-center rounded-full bg-green-100 text-xs font-semibold text-green-600 dark:bg-green-900 dark:text-green-300">
                                                @{{ index + 1 }}
                                            </span>
                                            <span class="text-sm font-medium dark:text-gray-300">@{{ territory.name
                                                }}</span>
                        ...
                        async fetchAnalytics() {
                            ...
                            try {
                                ...
                                const [overviewResponse, territoriesResponse, topRevenueResponse, topConversionResponse, topLeadsResponse] = await Promise.all([
                                    ...
                                    this.$axios.get("{{ route('admin.settings.territories.analytics.all_territories') }}"),
                                    this.$axios.get("{{ route('admin.settings.territories.analytics.top_by_revenue') }}?limit=5"),
                                    this.$axios.get("{{ route('admin.settings.territories.analytics.top_by_conversion_rate') }}?limit=5"),
                                    this.$axios.get("{{ route('admin.settings.territories.analytics.top_by_lead_count') }}?limit=5"),
                                ]);
