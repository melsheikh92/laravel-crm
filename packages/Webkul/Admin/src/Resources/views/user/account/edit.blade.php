<x-admin::layouts>
    ...
    <x-slot:title>
        ...
        <!-- Input Form -->
        <x-admin::form :action="route('admin.user.account.update')" enctype="multipart/form-data" method="PUT">
            <div
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <!-- Breadcrumbs -->
                    <x-admin::breadcrumbs name="dashboard.account.edit" :entity="$user" />
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="name" rules="required"
                                :value="old('name') ?: $user->name" :label="trans('admin::app.account.edit.name')"
                        ...
                        <x-admin::form.control-group class="!mb-0">
                            ...
                            <x-admin::form.control-group.control type="email" name="email" id="email" rules="required"
                                :value="old('email') ?: $user->email" :label="trans('admin::app.account.edit.email')" />
                            ...
                            <x-slot:header>
                                ...
                                <x-slot:content>
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control type="password" name="current_password"
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control type="password" name="password"
                                            rules="min:6" :placeholder="trans('admin::app.account.edit.password')"
                                            ref="password" />
