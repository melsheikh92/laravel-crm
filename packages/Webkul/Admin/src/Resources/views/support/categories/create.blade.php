<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.support.categories.create.title')
        </x-slot>

        <x-admin::form :action="route('admin.support.categories.store')">
            <div
                class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                <div class="flex flex-col gap-2">
                    <x-admin::breadcrumbs name="support.categories.create" />
                ...
                <button type="submit" class="primary-button">
                    @lang('admin::app.support.categories.create.save-btn')
                </button>
            </div>
                ...
                <div
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control type="text" name="name" rules="required"
                            :value="old('name')" :placeholder="trans('admin::app.support.categories.create.name')" />
