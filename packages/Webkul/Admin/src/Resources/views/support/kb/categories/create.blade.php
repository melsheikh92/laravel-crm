<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.support.kb.categories.create.title')
        </x-slot>

        <x-admin::form :action="route('admin.support.kb.categories.store')">
            <div
                class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                <div class="flex flex-col gap-2">
                    <x-admin::breadcrumbs name="support.kb.categories.create" />
                ...
                <button type="submit" class="primary-button">
                    @lang('admin::app.support.kb.categories.create.save-btn')
                </button>
            </div>
            ...
            <div class="mt-3.5">
                <div
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control type="select" name="parent_id">
                            <option value="">@lang('admin::app.support.kb.categories.create.select-parent')
                            </option>
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control type="text" name="sort_order" rules="required|numeric"
                            value="0" />
