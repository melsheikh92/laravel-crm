<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.support.kb.edit.title')
    </x-slot>

    <x-admin::form :action="route('admin.support.kb.articles.update', $article->id)" method="PUT">
        <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            <div class="flex flex-col gap-2">
                <x-admin::breadcrumbs name="support.kb.articles.edit" :entity="$article" />
            ...
            <button type="submit" class="primary-button">
                @lang('admin::app.support.kb.edit.update-btn')
            </button>
        </div>
