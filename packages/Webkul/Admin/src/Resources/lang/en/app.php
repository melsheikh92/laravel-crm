...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Powered by :krayin by :webkul.',
            ],

            'forecasts' => 'Forecasts',
            'forecast-dashboard' => 'Forecast Dashboard',
            'forecast-accuracy' => 'Forecast Accuracy',
            'team-forecasts' => 'Team Forecasts',
    ...
    'settings' => [
        ...
        'webforms' => [
            ...
            'create' => [
                ...
                'enter-message' => 'Enter message to display',
                'enter-url' => 'Enter url to redirect',
            ],
        ...
        'mail-configuration' => [
            'index' => [
                ...
                'testing' => 'Testing...',
                'save-success' => 'Mail configuration saved successfully.',
                'smtp-tab' => 'SMTP',
                'imap-tab' => 'IMAP',
                'templates-tab' => 'Templates',
                'smtp-test-success' => 'SMTP connection successful.',
                'smtp-test-failed' => 'SMTP connection failed: :error',
                'imap-test-success' => 'IMAP connection successful.',
                'imap-test-failed' => 'IMAP connection failed: :error',
                ...
                'smtp' => [
                    'title' => 'SMTP Settings',
                    'info' => 'Configure your SMTP settings for sending emails.',
                    'host' => 'SMTP Host',
                    'host-hint' => 'Enter your mail server host name (e.g., smtp.gmail.com).',
                    'port' => 'SMTP Port',
                    'port-hint' => 'Enter port number (e.g., 587 for TLS, 465 for SSL).',
                    'encryption' => 'Encryption',
                    'encryption-hint' => 'Select the encryption protocol used by your mail server.',
                    'username' => 'SMTP Username',
                    'username-hint' => 'Enter your email account username.',
                    'password' => 'SMTP Password',
                    'password-hint' => 'Enter your email account password.',
                    'from-address' => 'From Address',
                    'from-address-hint' => 'The email address that will appear in the "From" field.',
                    'from-name' => 'From Name',
                    'from-name-hint' => 'The name that will appear in the "From" field.',
                ],

                'imap' => [
                    'title' => 'IMAP Settings',
                    'info' => 'Configure your IMAP settings for receiving emails.',
                    'host' => 'IMAP Host',
                    'host-hint' => 'Enter your IMAP server host name (e.g., imap.gmail.com).',
                    'port' => 'IMAP Port',
                    'port-hint' => 'Enter port number (e.g., 993 for SSL).',
                    'encryption' => 'Encryption',
                    'encryption-hint' => 'Select the encryption protocol.',
                ...
                'templates' => [
                    'title' => 'Email Templates',
                    'info' => 'Manage email templates for various system notifications.',
                    'manage-templates' => 'Manage Templates',
                    'description' => 'You can customize the email templates used for system notifications and correspondence. Click the button above to manage them.',
                ],

                'providers' => [
                    'title' => 'Common Provider Settings',
                    'info' => 'Reference settings for popular email providers.',
                    'gmail' => [
                        'name' => 'Gmail',
                        ...
                        'imap-port' => '993',
                        'imap-encryption' => 'SSL',
                        'note' => 'Note: You may need to generate an App Password in your Google Account settings.',
                    ],
                    'outlook' => [
                    ...
                    'yahoo' => [
                        ...
                        'imap-port' => '993',
                        'imap-encryption' => 'SSL',
                        'note' => 'Note: Use an App Password generated in your Yahoo Account security settings.',
                    ],
                ],
            ],
        ],
        ...
        'marketing' => [
            'campaigns' => [
                ...
                'cannot-delete' => 'Campaign cannot be deleted while sending or completed.',
                'schedule-success' => 'Campaign scheduled successfully.',
                'send-success' => 'Campaign sending started.',
                'cancel-success' => 'Campaign cancelled successfully.',
                'recipients-added' => 'Recipients added successfully.',
            ],
            'templates' => [
                'index' => [
                    'title' => 'Email Templates',
                ...
                'cannot-delete' => 'Template cannot be deleted as it is used in campaigns.',
            ],
            'events' => [
                'index' => [
        ...
        'territories' => [
            'index' => [
                ...
                'view-hierarchy-btn' => 'View Hierarchy',
                'create-success' => 'Territory created successfully.',
                'update-success' => 'Territory updated successfully.',
                'delete-success' => 'Territory deleted successfully.',
                'delete-failed' => 'Territory can not be deleted.',

                'datagrid' => [
                    'id' => 'ID',
                    'name' => 'Name',
                    'type' => 'Type',
                    'parent' => 'Parent Territory',
                    'owner' => 'Owner',
                    'status' => 'Status',
                    'edit' => 'Edit',
                    'delete' => 'Delete',
            ...
            'hierarchy' => [
                ...
                'empty-info' => 'Create your first territory to get started with territory management.',
                'create-first-btn' => 'Create First Territory',
                'active' => 'Active',
                'inactive' => 'Inactive',
                'view-btn' => 'View',
                'edit-btn' => 'Edit',
            ...
            'rules' => [
                'index' => [
                    ...
                    'delete-failed' => 'Rule cannot be deleted.',
                    'toggle-success' => 'Rule status toggled successfully.',
                    'toggle-failed' => 'Failed to toggle rule status.',
                    'priority-success' => 'Rule priority updated successfully.',
                    'priority-failed' => 'Failed to update rule priority.',
                    'bulk-priority-success' => 'Rule priorities updated successfully.',
                    'bulk-priority-failed' => 'Failed to update rule priorities.',
                ],

                'create' => [
                    'title' => 'Create Territory Rule',
                    'territory' => 'Territory',
                    'save-btn' => 'Save Rule',
                    'general' => 'General',
                    'rule-type' => 'Rule Type',
                    'field-name' => 'Field Name',
                    'field-name-placeholder' => 'e.g., address.state, industry, revenue',
                    'operator' => 'Operator',
                    'priority' => 'Priority',
                    'priority-placeholder' => 'Higher number = higher priority',
                    'is-active' => 'Active',
                    'rule-value' => 'Rule Value',
                    'value-json' => 'Value (JSON)',
                    'value-info' => 'Enter the rule value in JSON format (e.g., ["California", "Texas"] for \'in\' operator)',
            ...
            'analytics' => [
                ...
                'performance-by-territory' => 'Performance by Territory',
                'territory-details' => 'Territory Performance Details',
                'territory-name' => 'Territory',
                'leads' => 'Leads',
                'won' => 'Won',
                'conversion-rate' => 'Conversion Rate',
                'revenue' => 'Revenue',
                'top-by-revenue' => 'Top Territories by Revenue',
                'top-by-conversion' => 'Top by Conversion Rate',
                'top-by-leads' => 'Top by Lead Count',
                'no-data' => 'No data available',
                'error-loading-data' => 'Failed to load analytics data',
                'territory-not-found' => 'Territory not found',
                'invalid-months-range' => 'Invalid months range. Must be between 1 and 24.',
            ...
            'map' => [
                ...
                'organizations' => 'Organizations',
                'persons' => 'Persons',
                'no-territories' => 'No territories with boundaries found',
                'assignment-density' => 'Assignment Density',
                'no-assignments' => 'No Assignments',
                'error-loading-data' => 'Failed to load territory map data',
                'no-boundaries' => 'This territory has no geographic boundaries defined.',
            ],

            'coverage' => [
                'title' => 'Territory Coverage Analytics',
                ...
                'entities-per-territory' => 'Entities Per Territory',
                'density-map' => 'Entity Density Map',
                'show-density' => 'Show Density Layer',
                'all-territories' => 'All Territories',
                'with-coverage-only' => 'With Coverage Only',
                'gaps-only' => 'Gaps Only',
                'highest-density' => 'Highest Density Territories',
                'entities' => 'Entities',
                'no-data' => 'No data available',
                'coverage-gaps-list' => 'Coverage Gaps',
                'no-coverage' => 'No Coverage',
                'no-gaps' => '✓ All territories have coverage!',
                'code' => 'Code',
                'status' => 'Status',
        ...
        'territory-assignments' => [
            'index' => [
                ...
                'create-btn' => 'Create Assignment',
                'bulk-reassign-btn' => 'Bulk Reassign',
                'bulk-reassign-title' => 'Bulk Reassign Territories',
                'bulk-reassign-submit' => 'Reassign Selected',
                'bulk-reassign-info' => 'Select rows from the grid to reassign them to a new territory.',
                'territory' => 'Territory',
                'select-territory' => 'Select Territory',
                'transfer-ownership' => 'Transfer Ownership',
                'selected-entities' => 'Selected Entities',
                'no-entities-selected' => 'Please select at least one entity to reassign.',
                'create-success' => 'Assignment created successfully.',
                'delete-success' => 'Assignment deleted successfully.',
                'delete-failed' => 'Assignment cannot be deleted.',
                'reassign-success' => 'Entity reassigned successfully.',
                'bulk-reassign-success' => ':count entities reassigned successfully.',
                'bulk-reassign-failed' => 'Failed to reassign entities.',
                'entity-not-found' => 'Entity not found.',
                'no-entities-found' => 'No entities found to reassign.',
                'lead' => 'Lead',
                'organization' => 'Organization',
                'person' => 'Person',
                'manual' => 'Manual',
            ...
            'create' => [
                'title' => 'Create Territory Assignment',
                'save-btn' => 'Create Assignment',
                ...
                'entity-id' => 'Entity ID',
                'entity-id-placeholder' => 'Enter the ID of the lead, organization, or person',
                'transfer-ownership' => 'Transfer Ownership to Territory Owner',
                'transfer-ownership-info' => 'When enabled, the entity owner will be changed to the territory owner.',
            ],
            ...
            'reassign' => [
                ...
                'current-territory' => 'Current Territory',
                'new-territory' => 'New Territory',
                'select-territory' => 'Select New Territory',
                'transfer-ownership' => 'Transfer Ownership to Territory Owner',
                'transfer-ownership-info' => 'When enabled, the entity owner will be changed to the new territory owner.',
                'unknown' => 'Unknown',
                'current' => 'Current',
            ],
            ...
            'history' => [
                ...
                'back-btn' => 'Back to Assignments',
                'entity' => 'Entity',
                'unknown' => 'Unknown',
                'empty-title' => 'No assignment history',
                'empty-info' => 'This entity has not been assigned to any territory yet.',
                'assigned-by' => 'Assigned By',
                'assignment-type' => 'Type',
                'deleted-territory' => 'Deleted Territory',
            ],
        ],
    ...
    'mail' => [
        ...
        'ai-reply-generated' => 'AI reply generated successfully.',
        'ai-summary-generated' => 'AI summary generated successfully.',
        ...
        'view' => [
            ...
            'no-summary' => 'No summary available. Click to generate.',
    ...
    'leads' => [
        ...
        'forecasts' => [
            'index' => [
                ...
                'generate-btn' => 'Generate Forecast',
                ...
                'error-loading-trends' => 'Error loading trends',
                'forecast-generated' => 'Forecast generated successfully',
                'error-generating-forecast' => 'Error generating forecast',
            ],
            'scenarios' => [
                ...
                'total-open-leads' => 'Total Open Leads',
            ...
            'accuracy' => [
                ...
                'forecasts-analyzed' => ':count forecasts analyzed',
                'accuracy-rate' => 'Accuracy Rate',
                'within-10-pct' => 'within 10%',
                'average-variance' => 'Average Variance',
                'average-diff' => 'average difference',
                'forecast-bias' => 'Forecast Bias',
                'over' => 'Over',
                'under' => 'Under',
                'forecast-vs-actual' => 'Forecast vs Actual',
                'variance-trends' => 'Variance Trends',
                ...
                'error-loading-data' => 'Error loading accuracy data',
            ],
        ],
    ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'title' => 'SMTP Settings',
                    'info' => 'SMTP email configuration for sending emails.',

                    'account' => [
                        'title' => 'SMTP Account',
                        'title-info' => 'Configure your SMTP account settings here.',
                        'host' => 'SMTP Host',
                        'port' => 'SMTP Port',
                        'encryption' => 'Encryption Type',
                        'username' => 'SMTP Username',
    ...
    'layouts' => [
        ...
        'territory-assignments' => 'Territory Assignments',
        'territory-assignments-info' => 'Manage territory assignments for leads and accounts',
        'territory-analytics' => 'Territory Analytics',
        'territory-analytics-info' => 'View territory performance metrics and reports',
    ...
    'collaboration' => [
        ...
        'mail-configuration' => [
            'index' => [
                ...
                'no-encryption' => 'No Encryption',
                'fill-required-fields' => 'Please fill all required fields',
                'smtp-test-failed' => 'SMTP connection test failed',
                'imap-test-failed' => 'IMAP connection test failed',

                'smtp' => [
                    'title' => 'SMTP Configuration',
                    'info' => 'Configure SMTP settings for sending emails',
                    'host' => 'Host Name',
                    'host-hint' => 'Enter your SMTP hostname (e.g. smtp.gmail.com)',
                    'port' => 'Port',
                    'port-hint' => 'Enter your SMTP port (e.g. 587)',
                    'encryption' => 'Encryption',
                    'encryption-hint' => 'Select the encryption method',
                    'username' => 'Username',
                    'username-hint' => 'Enter your SMTP username',
                    'password' => 'Password',
                    'password-hint' => 'Enter your SMTP password',
                    'from-address' => 'From Address',
                    'from-address-hint' => 'Enter the email address emails will be sent from',
                    'from-name' => 'From Name',
                    'from-name-hint' => 'Enter the name that will appear as the sender',
                ],

                'imap' => [
                    'title' => 'IMAP Configuration',
                    'info' => 'Configure IMAP settings for receiving emails',
                    'host' => 'Host Name',
                    'host-hint' => 'Enter your IMAP hostname',
                    'port' => 'Port',
                    'port-hint' => 'Enter your IMAP port',
                    'encryption' => 'Encryption',
                    'encryption-hint' => 'Select the encryption method',
                    'username' => 'Username',
                    'username-hint' => 'Enter your IMAP username',
                    'password' => 'Password',
                    'password-hint' => 'Enter your IMAP password',
                ],
                ...
                'providers' => [
                    ...
                    'gmail' => [
                        ...
                        'note' => 'Note: You may need to create an App Password if 2FA is enabled.',
                        'imap-host' => 'imap.gmail.com',
                        'imap-port' => '993',
                        'imap-encryption' => 'SSL',
                    ],
                    ...
                    'yahoo' => [
                        ...
                        'smtp-port' => '465',
                        'smtp-encryption' => 'SSL',
                        'note' => 'Note: You may need to generate a third-party app password.',
                        'imap-host' => 'imap.mail.yahoo.com',
                        'imap-port' => '993',
                        'imap-encryption' => 'SSL',
                    ],
                ...
                'templates' => [
                    'title' => 'Email Templates',
                    'info' => 'Manage your email templates',
                    'manage-templates' => 'Manage Templates',
                    'description' => 'You can create and manage email templates to use in your campaigns and automation.',
                ],
            ],
        ],
    ],
    ...
    'support' => [
        'tickets' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'delete' => 'Delete',
                    'mass-delete' => 'Mass Delete',
                    'mass-update-status' => 'Mass Update Status',
                ],
            ],
            'create' => [
                'title' => 'Create Ticket',
                'save-btn' => 'Create Ticket',
            ...
            'message-added' => 'Message added successfully',
            'assigned-success' => 'Ticket assigned successfully',
            'status-changed' => 'Status changed successfully',
            'closed-success' => 'Ticket closed successfully',
            'resolved-success' => 'Ticket resolved successfully',
            'attachment-uploaded' => 'Attachment uploaded successfully',
            'mass-update-success' => 'Tickets updated successfully',
            'mass-update-failed' => 'Failed to update tickets',
            'mass-delete-success' => 'Tickets deleted successfully',
            'mass-delete-failed' => 'Failed to delete tickets',
        ],
        ...
        'sla' => [
            ...
            'create' => [
                ...
                'rules' => 'SLA Rules',
                'priority' => 'Priority',
                'first-response-time' => 'First Response Time (minutes)',
                'resolution-time' => 'Resolution Time (minutes)',
                'add-rule' => 'Add Rule',
            ],
            'edit' => [
                'title' => 'Edit SLA Policy',
                'update-btn' => 'Update Policy',
            ],
            'create-success' => 'SLA Policy created successfully',
            'update-success' => 'SLA Policy updated successfully',
            'delete-success' => 'SLA Policy deleted successfully',
            'delete-failed' => 'Failed to delete SLA Policy',
        ],
        ...
        'categories' => [
            ...
            'create-success' => 'Ticket Category created successfully',
            'update-success' => 'Ticket Category updated successfully',
            'delete-success' => 'Ticket Category deleted successfully',
            'delete-failed' => 'Ticket Category deletion failed',
        ],

        'kb' => [
            'index' => [
                'title' => 'Knowledge Base Articles',
                'create-btn' => 'Create Article',
                'datagrid' => [
                    'id' => 'ID',
                    'title' => 'Title',
                    'category' => 'Category',
                    ...
                    'delete' => 'Delete',
                    'mass-delete' => 'Mass Delete',
                    'mass-publish' => 'Mass Update Status',
                ],
            ],
            'create' => [
                'title' => 'Create Article',
                'save-btn' => 'Create Article',
                'general' => 'General Information',
                'article-title' => 'Title',
                'content' => 'Content',
                'excerpt' => 'Excerpt',
            ...
            'delete-failed' => 'Failed to delete article',
            'published-success' => 'Article published successfully',
            'unpublished-success' => 'Article unpublished successfully',
            ...
            'categories' => [
                ...
                'create' => [
                    ...
                    'description' => 'Description',
                    'parent' => 'Parent Category',
                    'select-parent' => 'Select Parent Category',
                    'sort-order' => 'Sort Order',
                    'visibility' => 'Visibility',
