...
return [
    'modules' => [
        ...
        \Webkul\Collaboration\Providers\ModuleServiceProvider::class,
        \Webkul\Support\Providers\ModuleServiceProvider::class,
        \Webkul\Integration\Providers\ModuleServiceProvider::class,
    ],
