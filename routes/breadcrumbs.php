...
Breadcrumbs::for('settings.territories.view', function (BreadcrumbTrail $trail, $territory) {
    $trail->parent('settings.territories');
    $trail->push($territory->name, route('admin.settings.territories.view', $territory->id));
});

// Dashboard > Settings > Territories > Assignments
Breadcrumbs::for('settings.territories.assignments', function (BreadcrumbTrail $trail, $territory) {
...
// Dashboard > Settings > Territories > Analytics
Breadcrumbs::for('settings.territories.analytics', function (BreadcrumbTrail $trail, $territory) {
    $trail->parent('settings.territories.view', $territory);
